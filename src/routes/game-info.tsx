...
export const Route = createFileRoute("/game-info")({
  head: () => ({
    meta: [
      { title: "Info Game - Kalajawi | Coming Soon" },
      {
        name: "description",
        content:
          "Info game Kalajawi - fitur permainan interaktif budaya Jawa yang sedang dalam pengembangan. Nantikan kehadirannya!",
      },
      { property: "og:title", content: "Info Game - Kalajawi | Coming Soon" },
      {
        property: "og:description",
        content: "Fitur permainan interaktif budaya Jawa yang sedang dalam pengembangan.",
      },
      ...
      <main className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 pt-20">
        ...
        >
          <div className="rounded-xl border border-brand-gold/40 bg-brand-dark/95 p-8 sm:p-12 shadow-2xl shadow-brand-gold/10 backdrop-blur-md">
            ...
            >
              <Gamepad2 className="size-8 text-brand-gold" />
            </motion.div>
