...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://kalajawi.id/" },
      ...
      { name: "twitter:image", content: "https://kalajawi.id/og-image.webp" },
    ],
    links: [
...
function RootShell({ children }: { children: ReactNode }) {
  const jsonLd = {
    ...
    publisher: {
      ...
      logo: {
        "@type": "ImageObject",
        url: "https://kalajawi.id/og-image.webp",
      },
    },
    inLanguage: "id",
  };
