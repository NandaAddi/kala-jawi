...
export const Route = createFileRoute("/register")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://kalajawi.id/register" },
...
const registerSchema = z
  .object({
    firstName: z.string().min(2, "Nama depan minimal 2 karakter").min(1, "Nama depan harus diisi"),
    lastName: z
      .string()
                      ...
                      <FormItem className="flex items-start space-x-2 space-y-0">
                        ...
                        <div className="space-y-1">
                          <FormLabel className="text-sm text-white/80 cursor-pointer leading-tight">
                            ...
                            <a
                              href="#"
                              className="text-brand-gold hover:text-brand-light-gold underline underline-offset-2"
                            >
                              Syarat & Ketentuan
                            </a>
                          </FormLabel>
